...
Web 提供登录、头像与用户设置、用户级 Session 管理、历史消息、上下文占用与手动压缩/强制清空、附件、Skills/Styles 和文件树；主 Agent 还可把大文件检索、阅读、局部编辑和基于检查 Skill 的图片质检委派给单实例文件子 Agent，界面以紫色单独展示其工作过程；可预览
